...
void main() {
  ...
  testWidgets('Home shows custom header and bottom navigation', (WidgetTester tester) async {
    await pumpApp(tester);
  ...
  testWidgets('Home shows Medication card and Today card', (WidgetTester tester) async {
    await pumpApp(tester);
  ...
  testWidgets('Home shows Refill reminder and Upcoming appointments', (WidgetTester tester) async {
    await pumpApp(tester);
